#
# Be sure to run `pod lib lint TBBackend.podspec' to ensure this is a
...
Make app developers calling REST APIs easier, turbo building the connections between the frontend & the backend. Sending data to the backend & receiving data from the backend. Extract json objects from either json arrays / json objects
  ...
  s.author           = { 'CaptainShi' => 'hshi@highpoint.edu' }
  s.source           = { :git => 'https://github.com/CaptainShi/TBBackend.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'TBBackend/Classes/**/*'
  
  # s.resource_bundles = {
  #   'TBBackend' => ['TBBackend/Assets/*.png']
  # }
